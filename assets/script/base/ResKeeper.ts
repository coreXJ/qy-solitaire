...
import { AssetType, CompleteCallback, ProgressCallback, ResMgr } from "../manager/ResMgr";
...
export class ResKeeper extends Component {
    ...
    public load(...args: any) {
        // 调用加载接口
        ResMgr.instance.load.apply(ResMgr.instance, args);
    }
     ...
     */
    public onDestroy() {
        console.log("Reskeeper onDestroy",this.node?.name);
        this.releaseAssets();
    }
